...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "crack_T")
        self.add_class("object", 2, "crack_L")
        self.add_class("object", 3, "crack_Alligator")
        self.add_class("object", 4, "failure")
        self.add_class("object", 5, "patch")
        ...
        for a in annotations:
            ...
            name_dict = {"crack_T": 1,"crack_L": 2,"crack_Alligator": 3,"failure": 4,"patch": 5}
            # key = tuple(name_dict)
